...
export const TextareaInput = ({ value, onChange, disabled, id, placeholder, type }) => {
    return (
        <textarea
            ...
            id={id}
            value={value}
            className="resize-none bg-navy placeholder-white text-white focus:border focus:ring-secondary focus:border-secondary focus-visible:border focus-visible:ring-secondary focus-visible:border-secondary focus-visible:outline-none text-sm rounded-2xl block w-full px-4 py-3.5"
            placeholder={placeholder}
            onChange={onChange}
            disabled={disabled}
            type={type}
