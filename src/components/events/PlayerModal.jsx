...
import { getChainInfo, getRoleAbility, updatePlayerRole, updatePlayerSide, updatePlayerStatus } from '../../api/gameApi'
        ...
        >
            <div className="min-w-[312px] gap-4 max-w-[400px] p-6 shadow-lg w-[80%] h-[512px] rounded-2xl bg-navy flex flex-col justify-between items-center outline-none">
                ...
                <div className='w-full flex-1 flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col w-full relative'>
                        <label className='z-10 text-xs text-center bg-navy relative top-2 right-4 w-min whitespace-nowrap px-1' htmlFor={"status"}>زنجیر شده به بازیکن دیگر</label>
                        <FaAngleDown size={16} className="absolute left-4 top-8 pointer-events-none" />
